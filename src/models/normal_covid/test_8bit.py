...
report_dir = os.path.join("../../../../warp10data/ESA/reports", task, "8bit")
report_saved_models = os.path.join("../../../../warp10data/ESA/reports", task)
...
report = pd.read_excel(os.path.join(report_saved_models, "report_%s.xlsx" % cv))
...
# Generators
image_dataset = util_model.Dataset(partition["test"], labels, boxes, source, "test", low_quality=True)
