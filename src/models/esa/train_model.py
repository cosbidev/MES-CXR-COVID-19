...
plot_dir = os.path.join("./figures", task)
plot_dir_cv = os.path.join(plot_dir, str(cv))
util_data.create_dir(plot_dir_cv)

model_list = ["vgg11", "vgg13", "vgg16", "vgg19", "resnet18", "resnet34", "resnet50", "resnet101", "resnet152",
              "densenet121", "densenet169", "densenet161", "densenet201", "googlenet",  "mobilenet_v2",
              "resnext50_32x4d", "wide_resnet50_2"]
# "shufflenet_v2_x0_5", "shufflenet_v2_x1_0", "mnasnet0_5", "mnasnet1_0" "alexnet", "squeezenet1_0", "squeezenet1_1"
