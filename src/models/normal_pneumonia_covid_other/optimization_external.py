...
external_data = ["covidx_normal_pneumonia_covid", "brixia"]
source_dict = {"covidx_normal_pneumonia_covid": "../../../../warp10data/ESA/data/COVIDX/img", "brixia": "../../../../warp10data/ESA/data/Brixia/dicom_clean"}
