...
# Location of data
#source = "../data/Brixia/dicom_clean"
source = "../../../../warp10data/ESA/data/Brixia/dicom_clean"

#report_dir = os.path.join("./reports", task, "brixia")
report_dir = os.path.join("../../../../warp10data/ESA/reports", task, "brixia")
...
data_file = os.path.join("./data/processed", "brixia", "data.xlsx")
data = pd.read_excel(data_file, index_col=0, dtype=list)

# test file
test_file = os.path.join('./data/processed', "brixia", 'all.txt')
